...
#
# Helper function to save a list of images with their relating titles
#
def save_images(images, title_texts):
    cols = 5
    ...
    for x in zip(images, title_texts):        
        ...
        plt.imsave(fname=output, arr=image, cmap=plt.cm.gray)
        if (title_text != ''):
